...
% ==================== BƯỚC 2: TẢI MÃ NGUỒN ====================
\section{BƯỚC 2: Tải mã nguồn dự án bằng Git Clone}
...
\section{BƯỚC 3: Chuẩn bị file cấu hình môi trường (.env)}
...
\begin{enumerate}[leftmargin=5mm,itemsep=1pt]
  \item Tìm file có tên \textbf{\texttt{run.bat}} trong thư mục dự án \texttt{quanlykhachsan}.
...
% ==================== BƯỚC 6: CÁC CÂU LỆNH THƯỜNG DÙNG ====================
\section{BƯỚC 6: Các câu lệnh quản trị và vận hành thường dùng}
