...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\fontsize{8.5}{10.5}\selectfont\color{gray}\textbf{STAYGO HOTEL SYSTEM} -- Hướng dẫn cài đặt trên Windows}
\fancyhead[R]{\fontsize{8.5}{10.5}\selectfont\color{gray}Dành cho người mới bắt đầu}
\fancyfoot[L]{\fontsize{8.5}{10.5}\selectfont\color{gray}Tài liệu hướng dẫn triển khai hệ thống}
\fancyfoot[R]{\fontsize{8.5}{10.5}\selectfont\color{gray}Trang \textbf{\thepage}}
...
\begin{center}
  \vspace*{1mm}
  {\fontsize{9.5}{11.5}\selectfont\bfseries\color{AccentBlue} TÀI LIỆU HƯỚNG DẪN KỸ THUẬT VÀ TRIỂN KHAI PHẦN MỀM\par}
  \vspace{2mm}
  {\fontsize{17}{21}\selectfont\bfseries\color{PrimaryNavy} HƯỚNG DẪN CÀI ĐẶT VÀ KHỞI CHẠY DỰ ÁN\\TRÊN HỆ ĐIỀU HÀNH WINDOWS\par}
  \vspace{1.5mm}
  {\fontsize{10.5}{13.5}\selectfont\color{gray} (Tài liệu chi tiết từng bước từ A đến Z -- Dành cho người mới bắt đầu)\par}
  \vspace{2mm}
...
\begin{center}
  ...
  Nếu cần biên dịch lại tài liệu này sang PDF: Chạy lệnh \codeinline{xelatex huong\_dan\_cai\_dat\_windows.tex}}
\end{center}
