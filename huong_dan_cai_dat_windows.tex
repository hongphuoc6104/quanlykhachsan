...
\begin{enumerate}[leftmargin=5mm,itemsep=1pt]
  \item Truy cập kho mã nguồn GitHub: \url{https://github.com/hongphuoc6104/quanlykhachsan}
  \item Bấm nút màu xanh \textbf{"<> Code"} $\rightarrow$ Chọn \textbf{"Download ZIP"}.
  \item Giải nén file vừa tải vào một thư mục trên máy bạn (Ví dụ: \texttt{D:\textbackslash qlks} hoặc \texttt{C:\textbackslash quanlykhachsan}).
\end{enumerate}
