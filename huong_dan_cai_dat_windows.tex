...
% ==================== BƯỚC 2: TẢI MÃ NGUỒN ====================
\section{BƯỚC 2: Tải mã nguồn dự án về máy tính (Git Clone)}

Mở cửa sổ dòng lệnh (\textbf{Command Prompt} hoặc \textbf{PowerShell}) và chạy các lệnh sau để tải mã nguồn từ GitHub về máy tính:
